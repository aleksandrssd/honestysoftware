                    ...
                    <div class="wrapper">                        
                        <div class="row clearfix">                            
                            <article class="grid_9">
                                ...
                                <ul class="our_process">
                                    <li class="img1">
                                        ...
                                        <h5>Step1: Planning</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                                    </li>
                                    <li class="img2">
                                        <h4>Friday, October 10, 2014</h4>
                                        <h5>Step2: Designing</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                                    </li>
                                    <li class="img3">
                                        <h4>Friday, October 10, 2014</h4>
                                        <h5>Step3: Development</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                                    </li>
                                    <li class="img4">
                                        <h4>Friday, October 10, 2014</h4>
                            ...
                            <article class="grid_3">
                                ...
                                <div class="widget">
                                    <h2 class="widget-title">Twitter Blog</h2>
                                    <a class="twitter-timeline"  href="https://twitter.com/TwitterDev" data-widget-id="524979312210898944">Tweets by @TwitterDev</a>
